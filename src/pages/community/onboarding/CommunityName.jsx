        ...
        <AppGrid container textAlign={'center'} justifyContent={'center'} rowSpacing={4} >
            <AppGrid item >
                <AppLabelComponent gap={2} variant="h4" label={'What is the name of your community?'}>
                    <AppAutoComplete valueParam='communityId' nameParam='name' name='communityName' error={touched.communityName && errors.communityName} loading={isLoading} onChange={handleChange} value={formValues.communityName} options={communityList?.data || []} placeholder='Enter your Community Name' onSearch={onSearch} />
                </AppLabelComponent>
