...
import UploadCommunity from "./UploadCommunity";
import UploadCommunityList from "./UploadCommunityList";
import UploadedCommunity from "./UploadedCommunity";
...
const onBoardingStepper = [
  ...
  {
    title: "",
    component: (props) => <UploadedCommunity {...props} />,
  },
];
const defaultValue = {
  onBoardingType: "single",
  ...
  const handleCommunityDetails = (key, value) => {
    ...
    if (key === "projectManager") {
      setValidationSchema((prevSchema) => {
        const updatedSchema = { ...prevSchema };
        value !== "true"
          ? delete updatedSchema.projectManager
          : (updatedSchema.projectManager =
              initialValidationSchema.communityManager);
        return updatedSchema;
      });
    }
