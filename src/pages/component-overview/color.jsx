...
export const ColorBox = ({ bgcolor, title, data, dark, main, borderRadius = '15px', duration = '' }) => {
  return (
      ...
      >
        {title && (
          <Stack direction="row" justifyContent="space-between" width="100%" alignItems="center">
            <Typography variant="subtitle1" color="#323C4D">
              {title}
            </Typography>
            {duration && <Typography variant="subtitle1" color="#323C4D">
              {duration}
            </Typography>}
          </Stack>
        )}
