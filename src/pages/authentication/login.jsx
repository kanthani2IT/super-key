    ...
    <AuthWrapper>
      <Grid2 container spacing={3}>
        <Grid2 item xs={12} justifyContent={"center"} display={"flex"}>
          ...
          <Logo />
          <Typography variant="h1" color="#288B5B" fontSize={"2rem"} fontWeight={700} lineHeight={'3rem'}>Welcome !</Typography>
            <Typography variant="h7" color="#5B738B" fontSize={"0.75rem"}>Login to your account</Typography>
          </Stack>
        </Grid2>
        <Grid2 item xs={12}>
